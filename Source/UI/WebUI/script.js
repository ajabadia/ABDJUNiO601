...
function callNative(name, ...args) {
    ...
    // NOTE: __juce__invoke and __juce__complete are JUCE internal event names used by
    // WebBrowserComponent's native integration bridge. These are implementation details
    // of JUCE 7/8's WebView bridge and may change between JUCE versions. If upgrading
    // JUCE, verify these event names against the updated WebBrowserComponent sources.
    const id = promiseId++;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('copy-syx-btn')?.addEventListener('click', () => {
