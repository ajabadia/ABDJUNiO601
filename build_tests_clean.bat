...
echo.
echo === Step 2: Configuring CMake for Super Six model ===
...
echo [OK] CMake configured (Super Six model).

echo.
echo === Step 3: Building JunoUnitTests ===
...
echo.
echo === Step 4: Running JunoUnitTests ===
echo.
